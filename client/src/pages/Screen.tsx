    ...
    <div className="bg-white w-full">
      ...
      <section className="w-full px-4 md:px-10 mt-6 md:mt-12">
        <div className="flex flex-col md:flex-row md:gap-8">
          {/* Title — mobile only, above photo */}
          <div className="md:hidden [font-family:'Manrope',Helvetica] font-normal text-[36px] leading-[42px] tracking-[0] mb-4">
          ...
          <div className="relative flex-shrink-0 w-full md:w-[38%]">
            ...
            <div className="absolute top-0 right-0 z-10 w-[70px] h-[70px] md:w-[97px] md:h-[97px]">
          ...
          <div className="flex-1 flex flex-col">
            <div className="mt-4 md:mt-0 md:self-end [font-family:'Manrope',Helvetica] font-normal text-[#343434] text-base md:text-xl md:text-right leading-[26px] md:leading-[30px] tracking-[0] max-w-[445px]">
              «Моя задача — чтобы проблемы бизнеса решались, а не обсуждались»
            </div>

            <div className="hidden md:block mt-auto [font-family:'Manrope',Helvetica] font-normal text-[80px] leading-[92px] tracking-[0]">
              <span className="text-[#202020]">Бизнес-юрист </span>
              <span className="font-semibold text-[#226a43]">
                Надежда Уварова
              </span>
            ...
            <div className="mt-3 [font-family:'Manrope',Helvetica] font-normal text-[#343434] text-base md:text-xl leading-[26px] md:leading-[30px] tracking-[0]">
