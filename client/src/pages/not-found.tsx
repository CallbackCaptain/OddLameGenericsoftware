      ...
      >
        ...
        <div className="max-[1023px]:block hidden max-w-[500px] w-[100%] relative">
          ...
          <ul className="absolute -translate-y-[-100%] w-[100%] pt-5 bottom-0 text-right text-[#787878]">
            ...
            <li className="mt-[12px]">
              <a target="_blank"  className="text-[13px] underline underline-offset-2 decoration-[0.5px]" href="https://sopryajenie.ru/">
        ...
        >
          <ul className="max-[1180px]:mb-[-30px] grid grid-cols-2 gap-x-4 gap-y-4 text-sm text-[#787878]">
            ...
            <li>
              <a target="_blank" className="max-[1180px]:text-[10px]  max-[1380px]:text-[11px] underline underline-offset-2 decoration-[0.5px]" href="/privacy">
                Политика обработки персональных данных
              </a>
            </li>
            <li>
              <a target="_blank" className="max-[1180px]:text-[10px] max-[1380px]:text-[11px] underline underline-offset-2 decoration-[0.5px]" href="/cookie">
                Правила использования Cookie
              </a>
            </li>
            <li>
              <a target="_blank" className="max-[1180px]:text-[10px] max-[1380px]:text-[11px] underline underline-offset-2 decoration-[0.5px]" href="https://sopryajenie.ru/">
                Разработано студией "Сопряжение"
              </a>
            </li>
          </ul>
